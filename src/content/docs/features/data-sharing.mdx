...
<StyledImage
lightSrc={lightDataLink}
darkSrc={darkDataLink}
alt="Screenshot of the Fileglancer interface, with one arrow pointing to the 'Create data link' switch in the Overview tab of the Properties panel."
/>
