...
These specialized features make it easy to browse, preview, and share large imaging datasets without leaving the file browser interface. For more details on using data viewers, see the [Integrated Data Tools](/features/image-support/#integrated-data-tools) guide.
