...
import lightHomeNavigation from '@assets/getting-started-images/light-home-button.png'
import darkHomeNavigation from '@assets/getting-started-images/dark-home-button.png'
import lightSearchAndZones from '@assets/getting-started-images/light-search-and-zones.png'
import darkSearchAndZones from '@assets/getting-started-images/dark-search-and-zones.png'
import lightSaveFavorite from '@assets/getting-started-images/light-save-favorite.png'
import darkSaveFavorite from '@assets/getting-started-images/dark-save-favorite.png'
import lightZarrDataLink from '@assets/getting-started-images/light-zarr-data-link.png'
import darkZarrDataLink from '@assets/getting-started-images/dark-zarr-data-link.png'
import lightZarrConversion from '@assets/getting-started-images/light-zarr-conversion-request.png'
import darkZarrConversion from '@assets/getting-started-images/dark-zarr-conversion-request.png'
