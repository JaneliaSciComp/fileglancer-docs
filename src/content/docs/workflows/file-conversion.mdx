...
Click on the "Conversion" tab within the Properties Panel.<br/><br/>
![Convert Tab](../../../assets/fileglancer-convert-tab.png)
*The Convert tab in the Properties Panel showing conversion request options*<br/>

5. **Open the conversion request**<br/>
Click the button or link to "Open conversion request". This will open a dialog.
...
Click on the Tasks page link at the top of the interface.<br/><br/>
![Tasks Page](../../../assets/fileglancer-tasks-page.png)
*The Tasks page showing conversion request status and history*<br/>
