...
6. Job status is monitored and updated in real time (PENDING → RUNNING → DONE/FAILED/KILLED). The commit the job executed is recorded and shown on its detail page.
