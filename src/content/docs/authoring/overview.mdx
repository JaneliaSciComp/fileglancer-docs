...
- **[Server Configuration](/authoring/server-config/)** — settings controlled by the server administrator (`extra_paths`, worker environment passthrough, unknown-job cutoff, container cache).
